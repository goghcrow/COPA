            ...
            while (entries.hasMoreElements()) {
                ...
                if (this.filterClassName(classSimpleName)) {
                    ...
                    try {
                        ...
                        log.error("Class.forName error:URL is ===>" + url.getPath());
                    }
                }
            }
        } catch (IOException e) {
            log.error("IOException error:URL is ===>" + url.getPath());
        } catch (Throwable e) {
            log.error("ScanPackageClassesByJar error:URL is ===>" + url.getPath());
        }
    }
